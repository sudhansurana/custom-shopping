        ...
        <span>
                ...
                <div className="product-card bg-white">
                    ...
                    <div className="product-card-details">
                        <div className="product-title-container">
                            ...
                            <span className="product-wishlist null" title="add to wishlist">
                        ...
                        <div className="product-features-container">
                            <div className="product-features">
                                ...
                                <div className="feature-fulfillmemt">
                                    <span className="shop-card-product-features" title="Duka Aproved">
                                        ...
                                        <span className="feature-text">Amazing Shop Aproved</span>
                                    </span>
                                    <span className="shop-card-product-features" title="Fullfiled By Duka">
                                        ...
                                        <span className="feature-text">Fullfiled By Amazing Shop</span>
                                    </span>
                            ...
                            <div className="product-features">
                                ...
                                <span className="feature-text feature-color">black</span>
                            </div>
                            <div className="product-features">
                                <p className="product-features-title text-muted">quantity:</p>
                                <div className="product-quantity">
                                    <button type="button" className="btn btn-secondary">-</button>
                                    <input name="quantity" type="text" className="form-control" placeholder="Qty" value="5"/>
                                    <button type="button" className="btn btn-secondary" >+</button>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container">
                <div className="products-section-title pb-3">
                    <h4></h4>
                    <a className="btn btn-link products-section-link" href="/products">See All</a>
                </div>
            </div>
        </span>
    )
